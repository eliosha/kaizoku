...
# Construct final database: ONLY keep products present in the new Sorted database
# This flushes out any old products from before!
final_database = {}
...
# Reconstruct window.productsDB text block
...
# Update navbar links in main.js
